...
static const adc_configTable_t ADC_ConfigTable[] = {
		{{RCC_APB2Periph_ADC3, ADC3, ADC_Channel_3}, {RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_3}},
		{{RCC_APB2Periph_ADC3, ADC3, ADC_Channel_10}, {RCC_AHB1Periph_GPIOC, GPIOC, GPIO_Pin_0}},
		{{RCC_APB2Periph_ADC3, ADC3, ADC_Channel_13}, {RCC_AHB1Periph_GPIOC, GPIOC, GPIO_Pin_3}},
		{{RCC_APB2Periph_ADC3, ADC3, ADC_Channel_9}, {RCC_AHB1Periph_GPIOF, GPIOF, GPIO_Pin_3}},
		{{RCC_APB2Periph_ADC3, ADC3, ADC_Channel_15}, {RCC_AHB1Periph_GPIOF, GPIOF, GPIO_Pin_5}},
		{{RCC_APB2Periph_ADC3, ADC3, ADC_Channel_8}, {RCC_AHB1Periph_GPIOF, GPIOF, GPIO_Pin_10}},
};
#endif
