...
static const uart_configTable_t UART_ConfigTable[] = {
		{
				...
				{RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_6, GPIO_PinSource6, GPIO_AF_USART1},
				{RCC_AHB1Periph_GPIOB, GPIOB, GPIO_Pin_7, GPIO_PinSource7, GPIO_AF_USART1},
				{RCC_AHB1Periph_DMA2, DMA2_Stream7, DMA_Channel_4, DMA_FLAG_TCIF7},
				{RCC_AHB1Periph_DMA2, DMA2_Stream2, DMA_Channel_4, DMA_FLAG_TCIF2},
		},
};
#endif
...
static uint8_t stm32Uart_SetBaudtrate(uint32_t baudrate)
{
	...
	/* Disable USART */
	USART_Cmd(UART_ConfigTable[0].Uart.UARTx, DISABLE);

	/* Get clock configuration */
	RCC_GetClocksFreq(&RCC_Clocks);

	/* Oversampling select */
	if(baudrate > RCC_Clocks.PCLK2_Frequency / 16)
