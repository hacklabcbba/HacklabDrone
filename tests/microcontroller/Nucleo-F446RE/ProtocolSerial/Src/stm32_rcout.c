...
static const rcout_configTable_t RCOUT_ConfigTable[] = {
		...
		},
		{
				...
				{RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_8, GPIO_PinSource8, GPIO_AF_TIM1},
				{RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_9, GPIO_PinSource9, GPIO_AF_TIM1},
				{RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_10, GPIO_PinSource10, GPIO_AF_TIM1},
				{RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_11, GPIO_PinSource11, GPIO_AF_TIM1},
		},
};
#endif
